...
/* This board macro selects the correct flash-device branch below. A fresh FSP project
 * does not pass -DBOARD_RA8P1_EK (it is a vendor-example build flag), so self-select it
 * when no board macro is present. The EK-RA8P1 carries the Macronix MX25LW51245G. */
